...
class SimpleHTTPRequestHandler(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if "target" in params:
            ...
            print "Opening URL: __" + params["target"][0] + "__"
    ...
    def send_head(self):
        ...
        """
        path, qpath, params = self.translate_path(self.path)
        f = None
    ...
    def translate_path(self, path):
        ...
        try:
            ...
            # the path is severely malformed, this is probably a responce header from rele
            return ("", "", {})
